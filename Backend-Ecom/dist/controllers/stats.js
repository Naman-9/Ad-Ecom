...
export const getDashboardStats = TryCatch(async (req, res, next) => {
    ...
    if (nodeCache.has(key))
        ...
        const latestTransactionPromise = Order.find({})
            ...
            .limit(4);
        const [thisMonthUser, thisMonthProducts, thisMonthOrders, lastMonthUser, lastMonthProducts, lastMonthOrders, productsCounts, userCounts, allOrders, lastSixMonthOrders, categories, femaleUsers, latestTransaction,] = await Promise.all([
        ...
        const categoriesCount = await getInventory({
            categories,
            productsCounts,
        });
        const usersRatio = {
...
export const getPieCharts = TryCatch(async (req, res, next) => {
    ...
    if (nodeCache.has(key))
        ...
        const [processingOrder, shippedOrder, deliveredOrder, categories, productsCounts, productsOutOfStock, allOrder, allUsers, adminUserCount, CustomerUserCount,] = await Promise.all([
