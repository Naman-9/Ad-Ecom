...
import { deleteProduct, getAllProducts, getAllProductsWithFilter, getCategories, getLatestProduct, getProductDetails, newProduct, updateProduct } from "../controllers/product.js";
